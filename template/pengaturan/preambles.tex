...
\renewcommand{\thesection}{\arabic{chapter}.\arabic{section}.}         % Subsection: 2.1.
\renewcommand{\thesubsection}{\thesection\arabic{subsection}.}         % Sub-subsection: 2.1.1.
...
\titleformat{\section}{\fontsize{12pt}{14pt}\bfseries}{\thesection}{0.4cm}{}
\titleformat{\subsection}{\fontsize{12pt}{14pt}\bfseries}{\thesubsection}{0.4cm}{}
...
% Mengatur nomor caption gambar dan tabel sesuai bab (Romawi Bab . Angka Gambar)
...
\geometry{
    ...
    top=3cm,           % Margin atas
    right=2.5cm,       % Margin kanan
    bottom=2.5cm,      % Margin bawah
    footskip=0.3cm,    % Margin footer (jarak teks ke nomor halaman)
}

% Pengaturan Header dan Footer (Penomoran Halaman)
\usepackage{fancyhdr}
\fancypagestyle{plain}{
    % Style untuk halaman awal bab (Chapter)
    \fancyhf{} % clear all header and footer fields
    \fancyfoot[C]{\thepage} % Bawah tengah
    \renewcommand{\headrulewidth}{0pt}
    \renewcommand{\footrulewidth}{0pt}
}
\fancypagestyle{main}{
    % Style untuk halaman selanjutnya
    \fancyhf{}
    \fancyhead[R]{\thepage} % Kanan atas
    \renewcommand{\headrulewidth}{0pt}
    \renewcommand{\footrulewidth}{0pt}
}
\pagestyle{main}
...
\usepackage{etoolbox}
\setlength{\bibsep}{2\baselineskip} % Jarak antar pustaka 2 spasi
...
%==================================================================
% Pengaturan Watermark UBSI (10cm x 10cm, Middle Center, Behind Text)
%==================================================================
\usepackage{eso-pic}
\newcommand\AktifkanWatermark{%
    \AddToShipoutPictureBG{%
        \begin{tikzpicture}[remember picture, overlay]
            \node[opacity=0.15] at (current page.center) {\includegraphics[width=10cm,height=10cm]{gambar/logo-ubsi.png}};
        \end{tikzpicture}%
    }
}
